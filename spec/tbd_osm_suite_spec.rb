...
RSpec.describe TBD_Tests do
  ...
  seed_osms = []
  # seed_osms << "seb.osm"
  # seed_osms << "secondaryschool.osm"
  seed_osms << "smalloffice.osm"
  seed_osms << "warehouse.osm"

  weather_files = {}
  # weather_files["seb.osm"] = "srrl_2013_amy.epw"
  # weather_files["secondaryschool.osm"] = "USA_TX_El.Paso.Intl.AP.722700_TMY3.epw"
  weather_files["smalloffice.osm"] = "USA_TX_El.Paso.Intl.AP.722700_TMY3.epw"
  weather_files["warehouse.osm"] = "USA_TX_El.Paso.Intl.AP.722700_TMY3.epw"
